...
I also realized how convenient a list of dictionaries is for this kind of project—filtering and selecting columns felt very natural—but it instantly shows why real databases use more optimized, columnar structures for huge datasets. This whole thing made SQL feel way less like magic. I now have a much better sense of the steps between typing a query and getting results back. It was challenging but super rewarding—one of the most fun projects I've worked on lately.